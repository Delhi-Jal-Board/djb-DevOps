# OCI Terraform modules for the deployment of UPYOG Application on OCI


Terraform modules will provision following oracle cloud service and provide the kubeconfig file. kubeconfig file will be further used for the deployment of the UPYOG application on OCI.
